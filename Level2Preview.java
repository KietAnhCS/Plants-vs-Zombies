...
public class Level2Preview extends World
{
    ...
    public void bgScrollAnimate()
    {
        ...
        else if ( count == 500 )
        {
            ...
            Greenfoot.setWorld(new PlayScene(CYS, level, seedbank, new Level2Preview(), new WinRepeater(), false));
        }
    }
