...
public class Cactus2 extends Plant {
    ...
    private final long BASE_SHOOT_DELAY = PlantRegistry.CACTUS2_SHOOT_DELAY;
    private long shootDelay = PlantRegistry.CACTUS2_SHOOT_DELAY;
    private PlayScene cachedPlayScene;
    
    public Cactus2() {
        maxHp = PlantRegistry.CACTUS2_HP;
        hp = maxHp;
