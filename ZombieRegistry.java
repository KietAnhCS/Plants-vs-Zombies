public class ZombieRegistry {
    ...
    public static final double BASIC_SPEED     = 1.0;
    ...
    public static final double CONE_SPEED      = 1.0;
    ...
    public static final double BUCKET_SPEED    = 1.0;
    ...
    public static final double BRICK_SPEED     = 0.8;
