...
public class RaZombie extends Zombie {
    ...
    public RaZombie() {
        ...
        wNormal = importAndScale(SpriteKey.RA_WALK.path, 39);
        eNormal = importAndScale(SpriteKey.RA_EAT.path, 50); 
        wDeath  = importAndScale(SpriteKey.RA_DEATH.path, 30);

        sStart = importAndScale(SpriteKey.RA_POWER_START.path, 20);
        ...
        this.currentState = new ArmoredZombieState(
            this,
            config.thresholds,
            new GreenfootImage[][] { wNormal, wNormal, wNormal },
            new GreenfootImage[][] { eNormal, eNormal, eNormal }
        );
    }
